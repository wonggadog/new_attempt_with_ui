...
<head>
    ...
    <link rel="icon" href="images/bucslogo1.png">
            ...
            <div class="row g-0">
                <div class="col-md-6 left-column">
                    <div class="text-center p-4">
                        <img src="images/bucslogo1.png" alt="BUCS Logo" class="logo">
                        <div class="mt-4">
                    ...
                    <div class="login-form-container p-4">
                        ...
                        <div class="d-grid gap-2">
                            <button class="btn btn-light google-btn" onclick="handleGoogleSignIn()">
                                <img src="images/googlelogo.png" alt="Google Logo" class="google-icon">
                                Sign in with Google
                            </button>
